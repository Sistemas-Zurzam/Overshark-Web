                            ...
                            <div class="p-5">
                                ...
                                <div class="mt-4 flex flex-wrap items-center gap-2">
                                    @foreach ($displayColors as $color)
                                        ...
                                        @endphp
                                        <button type="button" data-product-color data-image="{{ $color['image'] }}" class="h-5 w-5 rounded-full border border-[#8E8E8E] ring-offset-2 transition hover:ring-2 hover:ring-slate-300" style="background-color: {{ $swatchColor }}" aria-label="Ver color {{ $color['name'] }}"></button>
                                    @endforeach
                                </div>
                            </div>
                        </article>
